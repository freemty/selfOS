...
| `/interview` | Wiki gaps | Open questions, thin pages, timeline gaps, vague entities |
...
1. Open Questions from concept pages (priority 1)
2. Thin pages < 100 words (priority 2)
3. Vague entities with thin Mentions (priority 2)
4. Timeline gaps — months with < 5 sources (priority 3)
