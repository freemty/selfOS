...
if __name__ == '__main__':
    ...
    # Clean old source pages
    print("Cleaning old source pages...")
    old_files = list(output_dir.glob('*.md'))
    for f in old_files:
        f.unlink()
    print(f"Removed {len(old_files)} old source pages")
    print()
    ...
    claude_dir = kb_root / 'raw' / 'claude-conversations' / '2026-04-05-export'
